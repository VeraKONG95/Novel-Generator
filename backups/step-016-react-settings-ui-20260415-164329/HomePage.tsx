...
export function HomePage() {
  ...
  const projects = buildHomeProjects(currentProject, currentPath, recentProjects);
  ...
  const handleOpenDialog = async () => {
    ...
    if (result.error) {
      showNotification(`打开项目失败：${result.error}`, 'error');
    }
  };
        ...
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="text-sm">{busyId === 'dialog' ? '打开中...' : '打开项目'}</span>
            </button>
            <button
